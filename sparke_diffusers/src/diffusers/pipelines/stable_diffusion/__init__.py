...
try:
    ...
    _import_structure["pipeline_stable_diffusion_rke"] = ["RKEGuidedStableDiffusionPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_rke import RKEGuidedStableDiffusionPipeline
