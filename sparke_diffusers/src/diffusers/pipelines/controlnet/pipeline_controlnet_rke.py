...
class RKEGuidedStableDiffusionControlNetPipeline(
    DiffusionPipeline,
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # **** ADDED: CUSTOM GUIDANCE BLOCK (same as Stable Diffusion) ****
                return_kernels: bool = False,
                return_kernels = kwargs.get('return_kernels', False)
                rke_guided_sampler = kwargs.get('rke_guided_sampler', None)
